...
/**
 * Custom exception to use, for example, in validations at {@link com.github.DiachenkoMD.sevices.UsersService#registerUser(HttpServletRequest, HttpServletResponse) UsersService.registerUser}.
 */
